...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.txt_lef_name = QtWidgets.QLineEdit(Form)
        self.txt_lef_name.setObjectName("txt_lef_name")
        self.horizontalLayout_2.addWidget(self.txt_lef_name)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "输出LEF文件名"))
